...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-cream-100 text-navy-900">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Thomas Hildebrandt</h1>
        <h2 className="text-3xl md:text-5xl font-bold text-blue-600 mb-2">Oberbürgermeisterwahl 2024</h2>
      ...
      >
        <div className="h-screen" /> {/* Spacer to ensure content starts below the header */}
